      ...
      >
        <div className='mx-auto flex w-full max-w-[1200px] flex-col justify-center'>
          ...
          <div className='mt-8 flex w-full'>
            <div className='hidden h-64 max-w-[285px] flex-col gap-3 leading-[22.4px] xl:flex'>
              {categories.map((category: any) => (
                <button
                  key={category.name}
                  onClick={() => setActiveCategory(category.id)}
                  ...
                  } hover:button flex w-full min-w-max items-center justify-between gap-x-2 px-6 py-4`}
                >
